...
// SECURE VERSION: Manual JWT decode + Role-based access + Tenant isolation
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // ✅ LAYER 1: JWT VERIFICATION (via Supabase getUser)
    ...
    console.log(`[CreateUser] JWT verified for user: ${userId}`)
